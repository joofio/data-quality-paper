...
%As for the clinicians' assessment, we got 5 answers. Figure 5 shows the aggregated rankings of the clinicians per record and is ordered by the rank provided by the model.
